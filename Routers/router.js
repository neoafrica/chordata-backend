...
const { createPost, createUser, clinicalCase, clinicalPic, frontImage, getFrontImage, deleteFrontImage, StoryBillboard, getBillBoardImage, deleteStoryBillBoardImage, CreateCases } = require('../Controllers/createPost')
const { deletePost, updatePost, getPost, deleteUser, getUser, getLatestPost, searchPost, relatedPost, getClinicalPosts, login, getUserData, updateUserProfile, createStory, getStory, questions, getQuestions, AddComment, getComments, AddReply, deleteComment, recentQA, MyQA, Cases, getCase, RecentCase, recentCaseCategory, MyCase, RelatedCases, Like, unLike, myStory, Bookmark, unBookmark, BookmarkStory, UnBookmarkStory, Search, deleteQuestion, SearchAll, TotalUsers, DeleteUser, getCaseById, getAllComments, getStoryById, deleteCase, likeComment, unLikeComments, Otp, ResetPassword, getQuestionById, getAllCase, getStoryData, deleteThread, getQuestionsForAdmin } = require('../Controllers/Posts')
...
const { createThread, getThreads, LikeThread, unLikeThread, BookmarkThread, UnBookmarkThread, getBookmarkedThreads, getMyThreads, getThreadsById } = require('../Thread/Thread');
...
router.post("/threads",  upload.fields([
